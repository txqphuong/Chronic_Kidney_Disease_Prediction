...
cursor = conn.cursor()
st.set_page_config(page_title="Kidney Disease Prediction bằng BNB", page_icon=":hospital:", layout="wide")
st.title('BNB')
# Load the model
model = pickle.load(open('E:\\Nam 3\\TH ML\\Nhom02_ChuanDoanBenhThanManTinh\\Nhom02\\HocMayTH\\BNB.h5', 'rb'))
